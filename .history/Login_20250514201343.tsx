...
// import AsyncStorage from '@react-native-async-storage/async-storage';
// import { requestUserPermission } from './FcmService';
// import { Coordinates, getCurrentPosition } from './LocationService'; // Updated LocationService
// import { sendNotificationWithLocation } from './Backend/Data';
...
//   console.log('User Location:', location);
// } catch (locError) {
//   console.warn('Location fetch failed:', locError?.message || locError);
//   Alert.alert('Location Error', 'Unable to get your location. Please enable GPS.');
// }


//     // Save user data
//     const user = { phone: cleanedNumber, name: 'Test User', location };
//     await AsyncStorage.setItem('user', JSON.stringify(user));
...
if (location && token) {
      await sendNotificationWithLocation(
        location.latitude,
        location.longitude,
        token,
        cleanedNumber
