...
import { getCurrentPosition } from './LocationService'; // Import the location service
...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try
    {
    // Request for FCM permissions and get token
    ...
    // Get the current location
      ...
      {
      console.log('User Location:', location); // Log or store the location as needed
    } else
    {
